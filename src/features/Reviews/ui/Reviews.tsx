      ...
      <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-3">
                <Image
                  ...
                  alt="user"
                />
                <Link href={`/users/${encodeURIComponent(review.author)}`}>
        ...
        <div className="flex justify-between">
          <div className="flex gap-5">
            ...
            <button className="bg-frostedglass text-grey center hover:bg-grey/30 flex gap-1.5 rounded-xl px-3.5 transition-transform duration-400 hover:scale-105 hover:font-medium hover:text-blue-400/80">
